...
export function NewMemoryForm() {
  ...
  return (
    ...
    <textarea name='content' spellCheck={false} placeholder='Fique livre para adicionar fotos, vídeos e relatos sobre essa experiência que você quer lembrar para sempre.' className='w-full flex-1 resize-none rounded border-0 bg-transparent p-0 text-lg focus:ring-0 leading-relaxed text-gray-100 placeholder:text-gray-400'></textarea>
    <button type="submit" className="inline-block rounded-full bg-green-500 px-5 py-3 font-alt text-sm uppercase leading-none text-black hover:bg-green-600 self-end">Salvar</button>
</form>
  );
}